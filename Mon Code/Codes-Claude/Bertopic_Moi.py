...
file_path = "/Users/jerome/Documents/Master1/Semestre1/TER_Gestion_de_ Projet/Codes_Moi/code_extract_text_from_pdf/fichier_mis_a_jour.xlsx"
...
output_directory = "/Users/jerome/Documents/Master1/Semestre1/TER_Gestion_de_ Projet/Codes_Moi/code_extract_text_from_pdf"
...
for column in columns_to_analyze:
    ...
    # Récupération des informations des sujets
    topic_info = topic_model.get_topic_info()

    # Sauvegarde des informations des sujets dans un fichier Excel
    output_path = os.path.join(output_directory, f"{column}_bertopic_results.xlsx")
